...
public class UsuarioController {
    ...
    public ResponseEntity<UsuarioModels> postUsuario(@Valid @RequestBody UsuarioModels usuario) {
    ...
    public ResponseEntity<UsuarioModels> putUsuario(@Valid @RequestBody UsuarioModels usuario) {
